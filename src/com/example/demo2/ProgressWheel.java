...
public class ProgressWheel extends View {
    ...
    //View要绘制的颜色
    private int barColor = 0xAA000000;//条
    private int contourColor = 0xAA000000;//轮廓
    private int circleColor = 0x00000000;
    private int rimColor = 0xAADDDDDD;  //框
    ...
    private void setupBounds() {
        ...
        rectBounds = new RectF(paddingLeft,//RectF这个类包含一个矩形的四个单精度浮点坐标
                paddingTop,
                width - paddingRight,
    ...
    */
    ...
    public void incrementProgress() {
       ...
       if(progress>360){
        ...
        float f = ((float) progress / 360) * 100;
        setText(df.format(f) + "%");
       postInvalidate();
    }
